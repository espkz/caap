...
def process_pdf(pdf_path):
	...
	for pagenum, page in enumerate(extract_pages(pdf_path)):
		...
		for i,component in enumerate(page_elements):
			if (datetime.now()-start_time).total_seconds()>30: raise Exception
	...
	# Display the content of the whole pdf
	result = '\n\n\n'.join([''.join(text_per_page[x][4]) for x in text_per_page.keys()])
	return result
